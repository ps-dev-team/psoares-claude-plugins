...
description: >
  ...
  annotations", "I sent annotations", "added a couple of notes", "did one",
  "vê as anotações", "enviei anotações", or `/annotations`.
license: MIT
metadata:
  author: psoares
  version: "0.1"
...
4. When a round is handled, `rm -rf` its folder. The directory only ever
   holds what has not been read. It is gitignored; never commit it.
